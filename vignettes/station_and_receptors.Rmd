...
# Setup
Ensure that the `temploapiclient` package is installed and available to this vignette. You can do that by calling `pkgdown::build_site()`, which will also generate the `docs` folder or by simply calling `install.packages()`.
